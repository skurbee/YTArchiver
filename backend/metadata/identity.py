"""Local media identity matching using explicit catalog and duration probes."""
...
from .catalog import _fetch_per_video_upload_dates, _flat_playlist_bulk_stats
from .control import _enter_pause_wait, _exit_pause_wait
from .durations import _probe_durations_bulk
from .io import _folder_for_channel, _read_metadata_jsonl
from .normalize import _norm_title_for_match
from .scan import _read_info_json_vid, _scan_channel_videos
